...
TESTFILE = "D:/Coding Projects/DAnCE x UrbanBEATS Module/Test Data/caseyclyde_500m_testdata.csv"
...
class UB_TranslateBlockData(Module):
        ...
        def __init__(self):
            ...
            self.createParameter("blocksize", DOUBLE, "Size of the blocks in input map [m]")
            self.blocksize = 500.0
        ...
        def init(self):
            ...
            self.regiondata.addAttribute("BlockSize", DOUBLE, WRITE)
        ...
        def run(self):
            ...
            mapregion.SetField("BlockSize", self.blocksize)
